...
<h3>ข้อมูลส่วนตัว</h3>
  ...
  <tr>
    <td>
  <label>ชื่อ :  
  <input type="text" name="name" id="name" value="<? echo $applicantname_cv; ?>"class="required error"  /></label>
  </td><td><label>
   สกุล : <input name="surname" type="text"  class="required error" id="surname" value="<? echo $applicantsurname_cv; ?>">
  </label></td></tr></table>
  <label>รหัสบัตรประจำตัวประชาชน : <input name="citizen" type="text" class="required number" id="citizen" value="<? echo $citizenid; ?>" maxlength="13" validate="required:true">
  </label>
  <label>ที่อยู่ : <input name="address" type="text" id="address" value="<? echo $address1_cv; ?>" size="60" maxlength="100" ></label>
  <table>
  <tr><td>
  <label>
  ตำบล :  <input name="address2" type="text" id="address2" value="<? echo $address2_cv; ?>" maxlength="30"></label>
  </td>
  <td>
   <label>
  อำเภอ :  <input name="address3" type="text" id="address3" value="<? echo $address3_cv; ?>" maxlength="30"> </label>
  </td></tr></table>
...
จังหวัด :
	...
	<td> <label> รหัสไปรษณีย์ : <input name="zipcode" type="text" class="number" id="textfield" value="<? echo $zipcode; ?>" size="10" maxlength="5" validate="required:true">  </label>   </td>  
    </tr></table>
    
    <table>
    <tr><td>
	<label>มือถือ : <input name="mobile" type="text" class="number" id="textfield" value="<? echo $phoneno; ?>" maxlength="13" validate="required:true">     </label> </td>
	  
 <td> <label> e-mail : <input name="email" type="text"  id="textfield" value="<? echo $email;?>" size="35"  validate="required:true">    
  </label>
  </td></tr></table>
  </div>
  ...
  <div class="mr20" >
    ...
    <label>วุฒิการศึกษาเดิม :
     ...
     <td> <label>&nbsp;เกรดเฉลี่ยสะสม :
      <input name="gpa" type="text" class="required error" id="gpa" value="<? echo $gpax; ?>" size="10" maxlength="4" validate="required:true" />
      </label>
      </td></tr></table>
     <?php
...
?>
  ...
  <tr>
    <td><div align="center">1
      <input name="txtQUOTASTATUSID_1" type="hidden" id="txtQUOTASTATUSID_1" value="<? echo $quotastatusid1; ?>" />
      <input name="txtMINGPAX_1" type="hidden" id="txtMINGPAX_1" value="<? echo $mingpa; ?>" />
    </div></td>
    <td><div align="center">
        <input name="txtLEVELID_1" type="hidden" id="txtLEVELID_1" value="<? echo $levelid; ?>" />
        <input type="text" size="3" name="txtQUOTACODE_1"  id="txtQUOTACODE_1" value="<? echo $quotacode1; ?>"  readonly />
        
    </div></td>
    <td><div align="center">
      <center>
        <input type="text" size="40" name="txtQUOTANAME_1"  id="txtQUOTANAME_1" value="<? echo $quotaname1_cv; ?>" class="required error" readonly/>
      </center>
    </div></td>
    <td><div align="center">
      <center>
        <input type="text" size="15" name="txtLEVELABB_1" id="txtLEVELABB_1"  value="<? echo $levelabb1_cv; ?>"   readonly />
      </center>
    </div></td>
    <td><div align="center">
      <center>
