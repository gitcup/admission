...
<table width="950" border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
	...
	$strSEL .= " AND (((APPLICANT.APPLICANTMETHOD)='W') AND ((APPLICANT.APPLICANTSTATUS)='10')) ORDER BY APPLICANT.CREATEDATETIME ASC";		
	...
	$strSEL1 .= " AND(((APPLICANT.APPLICANTMETHOD)='W') AND ((APPLICANT.APPLICANTSTATUS)='10')) ORDER BY APPLICANT.CREATEDATETIME ASC) bc1  where rownum <= $goto ) where rnum > $pagelen2";
