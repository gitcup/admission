...
<table width="950" border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
	...
	$strSEL .= " AND (((APPLICANT.APPLICANTMETHOD)='A') AND ((APPLICANT.APPLICANTSTATUS)>='10') AND ((APPLICANT.FINANCESTATUS)='N') AND ((APPLICANTSELECTION.SEQUENCE)='1') AND ((QUOTASTATUS.STUDYPERIOD)='$studyperiod')) ORDER BY APPLICANT.CREATEDATETIME ASC";		
	...
	$strSEL1 = "SELECT * from(select rownum rnum, bc1.* from(SELECT APPLICANT.APPLICANTID,APPLICANT.APPLICANTCODE, PREFIX.PREFIXNAME, APPLICANT.APPLICANTNAME, APPLICANT.APPLICANTSURNAME, APPLICANT.GPAX, APPLICANT.CREATEDATETIME, APPLICANT.HOMEPHONENO, APPLICANT.APPLICANTMETHOD, APPLICANT.EDITSEQ FROM ((AVSREG.APPLICANT INNER JOIN AVSREG.PREFIX ON APPLICANT.PREFIXID = PREFIX.PREFIXID) INNER JOIN AVSREG.APPLICANTSELECTION ON APPLICANTSELECTION.APPLICANTID = APPLICANT.APPLICANTID) INNER JOIN AVSREG.QUOTASTATUS ON QUOTASTATUS.QUOTASTATUSID = APPLICANTSELECTION.QUOTASTATUSID ";
	 $first_where = 0;
		 if($re_acadyear != "") 
		{	
			if($first_where == 0)
	...
	$strSEL1 .= " AND(((APPLICANT.APPLICANTMETHOD)='A') AND ((APPLICANT.APPLICANTSTATUS)>='10') AND ((APPLICANT.FINANCESTATUS)='N') AND ((APPLICANTSELECTION.SEQUENCE)='1') AND ((QUOTASTATUS.STUDYPERIOD)='$studyperiod')) ORDER BY  APPLICANT.CREATEDATETIME ASC) bc1  where rownum <= $goto ) where rnum > $pagelen2";
