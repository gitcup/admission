      ...
      ?>
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <input name="txt2SCHOOLNAME_1"  value="<?php echo $schoolnamemas_cv; ?>"type="text" id="txt2SCHOOLNAME_1" size="50" readonly="readonly" validate="required:true" class="form-control" required />
        ...
        <div class="form-row">
            <div class="form-group col-md-2">
                ...
                <input type="text" name="jobphone"  value="<?php echo $phone1; ?>" class="form-control" required  >
            ...
            <div class="form-group col-md-2">
                <label >โทรสาร</label>
                <input type="text" name="jobphone2" id="jobphone2" value="<?php echo $phone2; ?>"class="form-control" required />
