...
<div class="jumbotron">
    ...
    <form action="add_applicantmas.php" method="post" enctype="multipart/form-data" name="register" class="cmxform" id="register" onsubmit="return check()">
        ...
        <label>สถานภาพการทำงาน ปัจจุบัน :      
            <input name="cjob" type="radio" value="1" <?php
            if ($sess_cjob == 1) {
                echo"checked='checked'";
            }
            ?>  />
            ทำงาน &nbsp;&nbsp;&nbsp;
            <input name="cjob" type="radio" value="0" <?php
            if ($sess_cjob == 0) {
                echo"checked='checked'";
            }
            ?>  />
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-2">
                ...
                <input name="salary" type="text" id="salary" size="15" pattern="[0-9]" title="คุณกรอกรายได้ไม่ถูกต้อง" value="<?php echo $sess_salary; ?>"  onKeyUp="if (isNaN(this.value)) {
        ...
        <div class="form-row">
            <div class="form-group col-md-2">
                ...
                <input type="text" name="phone"  pattern="[0-9]" title="คุณกรอกเบอร์โทรศัพท์ไม่ถูกต้อง" value="<?php echo $sess_jobphone; ?>" class="form-control" required  >
            ...
            <div class="form-group col-md-2">
                <label >โทรสาร</label>
                <input type="text" name="jobphone2" id="jobphone2" pattern="[0-9]" title="คุณกรอกเบอร์โทรโทรสารไม่ถูกต้อง" value="<?php echo $sess_jobphone2; ?>"class="form-control" required />
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><div align="center">
                                ...
                                <input type="text" size="3" name="txtQUOTACODE_1"  value="<?php echo $sess_ccode1; ?>" id="txtQUOTACODE_1"  class="form-control" required />

                            </div></td>
                        <td><div align="center">
                                <center>
                                    <input type="text" size="40" name="txtQUOTANAME_1"  id="txtQUOTANAME_1" value="<?php echo $sess_qname1; ?>" class="form-control" required/>
                                </center>
                            </div></td>
                        <td><div align="center">
                                <center>
                                    <input type="text" size="15" name="txtLEVELABB_1" id="txtLEVELABB_1"  value="<?php echo $sess_labb1; ?>"  class="form-control" required />
                                </center>
                            </div></td>
                        <td><div align="center">
                                <center>
