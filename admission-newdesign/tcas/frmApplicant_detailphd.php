...
<?php echo $appstatus_cv; ?></li>
    ...
    <?php } else {
        if ($levelid == '42') {
            ?>
                                        <a class="btn btn-success" a href="pay_entrymas.php?levelid=<?php echo $levelid; ?>&period=<?php echo $period; ?>"  role="button" target="_blank"><span class="glyphicon glyphicon-print"></span>พิมพ์ใบชำระเงิน</a>

        <?php } else { ?> 	           <a class="btn btn-success" href="pay_entryphd.php?levelid=<?php echo $levelid; ?>&period=<?php echo $period; ?>" role="button" target="_blank"><span class="glyphicon glyphicon-print"></span>พิมพ์ใบชำระเงิน</a>
        <?php }
    }
    ?>
                 <br>  <br>              
    <?php if (($finance == 'D') or ( $finance == 'N')) {
        if ($levelid == '42') {
            ?><a class="btn btn-primary" href="frmPrint2mas.php" role="button" target="_blank"><span class="glyphicon glyphicon-print"></span>พิมพ์เอกสารหลักฐานการสมัคร</a>
                                     
        <?php } else { ?> 	 <a class="btn btn-primary" href="frmPrint2phd.php" role="button" target="_blank"><span class="glyphicon glyphicon-print"></span>พิมพ์เอกสารหลักฐานการสมัคร</a><?php }
    } else {
        ?>
