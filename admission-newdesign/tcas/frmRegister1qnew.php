            ...
            <form action="add_applicantqnew.php" method="post" enctype="multipart/form-data" name="register" class="cmxform" id="register" onsubmit="return check()">
                ...
                <div class="border-bottom" >
                    ...
                    <table width="25%" border="0">
                        <tr>
                        <label>ชื่อ-สกุล :
                            <input type="text" name="name" id="name" class="form-control" required value="<?php echo $sess_name; ?>" /></label></td>
                        <label>สกุล : <input type="text" name="surname" id="surname"  class="form-control" required value="<?php echo $sess_surname; ?>"></label></td>
                        </tr>
                    </table>
                    <table>
                        <tr>
                            <td> <label>รหัสบัตรประจำตัวประชาชน : <input name="citizen" value="<?php echo $sess_citizenid; ?>" type="tel" id="citizen" maxlength="13" pattern="[0-9]{13}" title="คุณกรอกรหัสประชาชนไม่ถูกต้อง" validate="required:true" class="form-control" required></label></td>
                        </tr>
                    </table>
                    <table>
                        <tr>
                            <td>  <label>ที่อยู่ : <input name="address" type="text" id="address" value="<?php echo $sess_address;?>" size="40" maxlength="100" class="form-control" required ></label> </td>
                        </tr>
                    </table>
                    <table>
                        <tr>
                            <td>  <label>
                                    ตำบล :  <input name="address2" type="text" id="address2" maxlength="30" value="<?php echo $sess_address2;?>"  class="form-control" required></label></td>
                            <td><label>อำเภอ :  <input name="address3" type="text" id="address3" maxlength="30" value="<?php echo $sess_address3;?>" class="form-control" required></label></td>
                        </tr>
                    </table>
                    <table>
                        <tr>
                            ...
                            <td><label> รหัสไปรษณีย์ : <input name="zipcode" type="text" value="<?php echo $sess_zipcode;?>" class="form-control" required id="textfield" size="10" maxlength="5"  pattern="[0-9]{5}" title="คุณกรอกรหัสไปรษณีย์ไม่ถูกต้อง" validate="required:true">  </label> </td>
                        </tr>
                    </table>
                    <table>
                        <tr>
                            <td>  <label>
                                    มือถือ : <input name="mobile" type="text" value="<?php echo $sess_mobile;?>" class="form-control" required id="textfield" maxlength="13" pattern="[0-9]{3}[0-9]{3}[0-9]{4}" title="คุณกรอกเบอร์มือถือไม่ถูกต้อง" validate="required:true"> </label></td>
                                    <td><label>e-mail : <input name="email" type="email"  id="textfield" value="<?php echo $sess_email;?>" size="30"  validate="required:true" class="form-control" required> </label></td>
                        </tr>
                    </table>
                ...
                <div class="border-bottom"  >
                    ...
                    <table>
                        <tr>
                            ...
                            <td><label>
                                    &nbsp;เกรดเฉลี่ยสะสม :
                                    <input name="gpa" type="text" id="gpa" value="<?php echo $sess_gpax; ?>" size="10" maxlength="4" validate="required:true" class="form-control" required />
                                </label>
                            </td></tr></table>
                    <label class="label2">สถาบันเดิมที่จบ
                        <input name="txtSCHOOLID_1" type="hidden" id="txtSCHOOLID_1" value="<?php echo $sess_schoolid; ?>" />
                        :
                        <input name="txtSCHOOLNAME_1"  value="<?php echo $sess_schoolname;?>"type="text" id="txtSCHOOLNAME_1" size="50"  validate="required:true" class="form-control" required/>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td><div align="center">
                                        ...
                                        <input type="text" size="3" name="txtQUOTACODE_1"  value="<?php echo $sess_ccode1; ?>" id="txtQUOTACODE_1"  readonly class="form-control"  />

                                    </div></td>
                                <td><div align="center">
                                        <center>
                                            <input type="text" size="40" name="txtQUOTANAME_1"  id="txtQUOTANAME_1" value="<?php echo $sess_qname1; ?>" class="form-control" readonly/>
                                        </center>
                                    </div></td>
                                <td><div align="center">
                                        <center>
                                            <input type="text" size="15" name="txtLEVELABB_1" id="txtLEVELABB_1"  value="<?php echo $sess_labb1; ?>"   readonly class="form-control"  />
                                        </center>
                                    </div></td>
                                <td><div align="center">
                                        <center>
