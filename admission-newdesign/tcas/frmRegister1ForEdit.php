...
<script language="javascript">
	...
	{
		window.open('getData.php?Line='+intLine,'myPopup','width=650,height=450,toolbar=0, menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0');
	}
...
<h2>แก้ไขข้อมูลผู้รับสมัคร</h2>
<div id="form-regis">
<form action="edit_applicant.php" method="post" enctype="multipart/form-data" name="register" class="cmxform" id="register" onsubmit="return check()">
<h3>ข้อมูลส่วนตัว</h3>
  <div class="mr20" >
  <label>คำนำหน้า : 
  ...
  <label>ชื่อ-สกุล :  
  <input type="text" name="name" id="name" value="<?php echo $applicantname_cv; ?>"class="required error"  />
   - <input name="surname" type="text"  class="required error" id="surname" value="<?php echo $applicantsurname_cv; ?>">
  </label>
  ...
  <label>
  ตำบล :  <input name="address2" type="text" id="address2" value="<?php echo $address2_cv; ?>" maxlength="30">
...
จังหวัด :
	  ...
	  รหัสไปรษณีย์ : <input name="zipcode" type="text" class="number" id="textfield" value="<?php echo $zipcode; ?>" size="10" maxlength="5" validate="required:true">  </label>     
	<label>มือถือ : <input name="mobile" type="text" class="number" id="textfield" value="<?php echo $phoneno; ?>" maxlength="13" validate="required:true">     
	  
  e-mail : <input name="email" type="text"  id="textfield" value="<? echo $email;?>" size="35"  validate="required:true">    
  </label>
  </div>
  ...
  <div class="mr20" >
    ...
    <label>วุฒิการศึกษาเดิม :
      ...
      &nbsp;เกรดเฉลี่ยสะสม :
      <input name="gpa" type="text" class="required error" id="gpa" value="<? echo $gpax; ?>" size="2" maxlength="4" validate="required:true" />
      </label>
     <?php
	...
	<label class="label2">สถาบันเดิมที่จบ
      <input name="txtSCHOOLID_1" type="hidden" id="txtSCHOOLID_1" value="<? echo $schoolid ?>"/>
      :
  <input name="txtSCHOOLNAME_1" type="text" id="txtSCHOOLNAME_1" size="50" value="<? echo $schoolname_cv ?>"readonly="readonly" validate="required:true" class="required error"/>
...
?>
  <tr>
    <td><div align="center">
      <input name="txtQUOTASTATUSID_2" type="hidden" id="txtQUOTASTATUSID_2" value="<?php echo $quotastatusid2; ?>" />
      <input name="txtMINGPAX_2" type="hidden" id="txtMINGPAX_2" />
    </div></td>
    <td><div align="center">
      <center>
        <input name="txtLEVELID_2" type="hidden" id="txtLEVELID_2" />
        <input type="text" size="3" name="txtQUOTACODE_2"  id="txtQUOTACODE_2" value="<?php echo $quotacode2; ?>" style="visibility: hidden;" readonly/>
      </center>
    </div></td>
    <td><div align="center">
      <center>
        <input type="text" size="40" name="txtQUOTANAME_2"  id="txtQUOTANAME_2" value="<?php echo $quotaname2_cv; ?>" style="visibility: hidden;" readonly/>
      </center>
    </div></td>
    <td><div align="center">
      <center>
        <input type="text" size="15" name="txtLEVELABB_2" id="txtLEVELABB_2"  value="<?php echo $levelabb2_cv; ?>" style="visibility: hidden;" readonly/>
      </center>
    </div></td>
    <td><div align="center">
      <center>
        <input type="button" name="btnPopup_2"  id="btnPopup_2" value="+" onclick="OpenPopup(2)" style="visibility: hidden;"/>
        <input type="button" name="btnPopup_2"  id="btnPopup_2" value="-" onclick="ClearForm(2)" style="visibility: hidden;"/>
      </center>
    </div></td>
  </tr>
</table>
  ...
  <input name="txtstatus" type="hidden" id="txtstatus" value="<?php echo $applicantstatus; ?>" />
  </div>
<!--
<h3>แนบไฟล์รูปภาพ</h3>
<div class="mr20" >
...
4. หากผู้สมัครต้องการเปลี่ยนสาขาจะต้องสมัครและชำระค่าธรรมเนียมการสมัคร 300 บาท ใหม่เท่านั้น<br/> โดยผู้สมัครสามารถเลือกว่าจะเข้าสอบสาขาใดก็ได้ที่ผู้สมัครเลือกไว้<br />
5. หลักฐานอื่นๆ นำมาแสดงในวันรายงานตัว <br/>
</div>
