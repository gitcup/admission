...
<?php include("sysconfigquota.php");  ?>
        ...
        <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
          ...
          <table width="100%" border="1" cellspacing="0" cellpadding="3">
            <tr>
			  ...
			  <?php 
			  	if($roundin == "2") {	echo " 1 ธ.ค. 2560 - 28 ก.พ. 2561"; } else {
			  	echo "หมดเขตชำระเงิน";}
			   // if($a_type == 'B') { echo datethai($datemoneyfrom); echo " ถึง ".datethai($datemoneyto);
			   // } else 
				//{ echo "หมดเขตชำระเงิน"; }  ?></strong><br>
