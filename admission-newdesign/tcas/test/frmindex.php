        ...
        <div class="jumbotron">
            ...
            <div class="row">
                <div class="col-xl-3" style="width:350px;" >
                    <ul class="list-group">
                        <li class="list-group-item" style="background: #0d2a4a;color: #ffffff;text-align: center;"><strong>1 . </strong>กรอกข้อมูลผู้สมัคร </li>
                ...
                <div class="col-xl-3" style="width:350px;" >
                    <ul class="list-group">
                        <li class="list-group-item" style="background: #0d2a4a;color: #ffffff;text-align: center;"><strong>2 . </strong>พิมพ์แบบฟอร์มชำระเงิน </li>
                ...
                <div class="col-xl-3" style="width:350px;" >
                    <ul class="list-group">
                        <li class="list-group-item" style="background: #0d2a4a;color: #ffffff;text-align: center;"><strong>3 . </strong>ชำระเงินที่ธนาคาร</li>
                ...
                <div class="col-xl-3" style="width:350px;" >
                    <ul class="list-group">
                        <li class="list-group-item" style="background: #0d2a4a;color: #ffffff;text-align: center;"><strong>4 . </strong>พิมเอกสารหลักฐานการสมัคร</li>
