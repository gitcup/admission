...
<?php $strSQL = "SELECT PREFIX.PREFIXNAME, APPLICANT.APPLICANTCODE, APPLICANT.ACADYEAR, APPLICANT.SEMESTER, APPLICANT.ROUND, APPLICANT.APPLICANTNAME, APPLICANT.APPLICANTSURNAME,APPLICANT.APPLICANTTYPE, APPLICANT.HOMEPHONENO, APPLICANT.GPAX, SCHOOL.SCHOOLNAME, ENTRYDEGREE.ENTRYDEGREENAME, APPLICANT.APPLICANTID FROM ((avsreg.APPLICANT INNER JOIN avsreg.PREFIX ON APPLICANT.PREFIXID = PREFIX.PREFIXID) INNER JOIN avsreg.SCHOOL ON APPLICANT.SCHOOLID = SCHOOL.SCHOOLID) INNER JOIN avsreg.ENTRYDEGREE ON APPLICANT.PROGRAMTYPE = ENTRYDEGREE.ENTRYDEGREECODE WHERE (((APPLICANT.APPLICANTID)='$applicantid') and ((APPLICANT.APPLICANTSTATUS)>='10'))";
      ...
      <tr>
        <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
          <tr>
            ...
            No.</div></td>
            <td width="59%"><div align="center" class="style3">รายการ</div></td>
            <td width="29%"><div align="center" class="style3">จำนวนเงิน<br>
            Amount(Baht)</div></td>
          </tr>
          <tr>
          ...
          <table width="100%" border="1" cellspacing="0" cellpadding="3">
            <tr>
			  ...
			  <?php 
			  	if($roundin == "3") {	echo " 18 - 22 ก.ค. 2561"; } else {
			  	echo "หมดเขตชำระเงิน"; }
			   // if($a_type == 'A') { echo datethai($datemoneyfrom); echo " ถึง ".datethai($datemoneyto);
			    //} else { echo "หมดเขตชำระเงิน"; }  ?></strong><br>
...
&nbsp;Rambhai Barni Rajabhat University</span></span></td>
            <td width="50%"><div align="right" class="style3"><span class="style7">ใบแจ้งการชำระเงินค่าสมัครเข้าศึกษาต่อ</span><br>
              กำหนดชำระเงินวันที่&nbsp;  <?php 
			  	...
			  	echo "หมดเขตชำระเงิน"; }
			    //if($a_type == 'A') { echo datethai($datemoneyfrom); echo " ถึง ".datethai($datemoneyto);
			    //} else { echo "หมดเขตชำระเงิน"; }  ?></div></td>
          </tr>
        </table></td>
        </tr>
      <tr>
