...
if ($a_type == 'A') { $text_type = "สอบคัดเลือก "; } 
			if ($a_type == 'Q') { $text_type = "โควตา"; } 
			if ($a_type == 'C') {$text_type = "รับตรง "; }
                        
//<!--//เช็คเงื่อนไข สาขาวิชา 2-->              
 if($q2 <> "") { echo $text_q2; } else { $text_q2 = " - "; } 
//<!--//เช็คเงื่อนไข สาขาวิชา 3 -->  
 if($q3 <> "") { echo $text_q3; } else { $text_q3 = " - "; } 
            
//<!--//เช็คเงื่อนไข สาขาวิชา 4 -->
  if($q3 <> "") { echo $text_q4; } else { $text_q4 = " - "; } 
...
//  เงื่อนไขการชำระเงิน
			    ...
			    if(($a_type == 'Q') and ($roundin == "3")) { $pay_text = datethai($datemoneyfrom) . " ถึง ".datethai($datemoneyto);
			    } else 
				{ $pay_text = "หมดเขตชำระเงิน"; }  ?>
