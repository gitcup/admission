...
if($levelid == '42') { $text_type = "โท"; } else { $text_type = "เอก"; } ?> <?php if($period == '1') { $text_type2 = "(ภาคปกติ)"; } else { $text_type2 = "(ภาคพิเศษ)"; } 
...
//<!--เงื่อนไขเงิน-->
if($levelid == '50') { $pa = $a2; $pb = $b2; $pc = 70000; } else { $pa = $a3; $pb = $b3; $pc = 30000;} ?>
...
<?php if ($datemoneyfrom <> "") { $pay_text = datethai($datemoneyfrom);

$pay_text2 = " ถึง ".datethai($datemoneyto); } else {  $pay_text = "หมดเขตชำระเงิน"; } ?>
...
<table width="650" border="0" align="center" cellpadding="3" cellspacing="0" >
    ...
    <th scope="col"><table width="100%" border="0" cellspacing="0" cellpadding="5">
      <tr>
        ...
        <th width="58%" scope="col" class="style3"  style="text-align:left"><span class="style1">มหาวิทยาลัยราชภัฏรำไพพรรณี<br />
            <span class="style2">ใบสมัครบุคคลเข้าศึกษาในระดับปริญญา ' . $text_type . ' '.$text_type2.'
            <br/>
          ประจำปีการศึกษา '.$semesterin."/".$acadyearin.' </span></span>Online</div></th>
              ...
              <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="DataTable">
                <tr>
                  ...
                  <td width="85%" bgcolor="#FFFFFF" class="style3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td bgcolor="#FFFFFF" class="style3">&nbsp;&nbsp; :&nbsp; '."<b>".$q1."</b>".'</td>
                      </tr>
                  </table></td>
                </tr>
 ...
 <th width="17%" scope="col"><img src="http://assess.rbru.ac.th/admission/images/logo3.png" width="40" height"auto" ></th>
            <th width="58%" scope="col" class="style3"  style="text-align:left"><span class="style1">มหาวิทยาลัยราชภัฏรำไพพรรณี<br />
            <span class="style2">Rambhai Barni Rajabhat University  
            <td width="50%" style="text-align:right"  class="style3"><span class="style7">ใบแจ้งการชำระเงินค่าสมัครเข้าศึกษาต่อ</span><br>
              กำหนดชำระเงินวันที่ ' . $pay_text . ' '.$pay_text2.'  </td>
          </tr>
        </table></td>
        </tr>
      <tr>
