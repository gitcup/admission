...
function simple_php_captcha($config = array()) {
	...
	$captcha_config = array(
		...
		'fonts' => array(
			...
			$font_path . 'EDSense Bold.ttf',
			$font_path . 'Waffle Regular.otf'
			//$font_path . 'Tear.ttf'			
		),
		'characters' => 'ABCDEFGHJKabcdefghjkLMNPRSTUVWXYZmnprstuvwxyz0123456789',
		'min_font_size' => 20,
		'max_font_size' => 28,
		'color' => '#767474',
		'angle_min' => 0,
	...
	if( $captcha_config['angle_max'] > 10 ) $captcha_config['angle_max'] = 3;
	...
	if( empty($captcha_config['code']) ) {
		...
		//echo $captcha_config['code'];
	}
	
	// Generate HTML for image src
        //ตำแหน่งรูปที่ต้องการแสดง
	$image_src = 'tcas/captcha/simple-php-captcha.php' . '?_CAPTCHA&amp;t=' . urlencode(microtime());
