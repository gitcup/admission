                        ...
                        <tr>
                            ...
                            <td><br>
                                <?php if ($applicantstatus < 10) { ?>
                                    ...
                                    <a  style="font-size: 20px;"class="btn btn-success" href="mpdf/pay_entry_mpdf.php" role="button" target="_blank"><i class="fa fa-print"></i>  พิมพ์ใบชำระเงิน</a><?php } if ($applicanttype == 'B') { ?>
                                            <a  style="font-size: 20px;"class="btn btn-success" href="mpdf/pay_entryquota_mpdf.php" role="button" target="_blank"><i class="fa fa-print"></i>  พิมพ์ใบชำระเงิน</a><?php } if ($applicanttype == 'Q') { ?>
                                            <a  style="font-size: 20px;"class="btn btn-success" href="mpdf/pay_entryqnew_mpdf.php" role="button" target="_blank"><i class="fa fa-print"></i>  พิมพ์ใบชำระเงิน</a><?php } ?>
                                    <?php } else { ?> <a class="btn btn-success" href="pay_entryexce.php" role="button" target="_blank"><i class="fa fa-print"></i>  พิมพ์ใบชำระเงิน</a> <?php
                                    }
                                }
                                ?>
                                <BR><BR><BR>
                                ...
                                if ($finance == 'N') {
                                    if ($period == '1') {
                                        ?>
                                        <a style="font-size: 20px;" class="btn btn-success" href="mpdf/formprint/frmPrint2_mpdf.php" role="button" target="_blank"><i class="fa fa-file"></i>พิมพ์เอกสารหลักฐานการสมัคร</a>


                                    <?php } else { ?> 	    <a style="font-size: 20px;" class="btn btn-success" href="frmPrint2exce.php" role="button" target="_blank"><i class="fa fa-file"></i>พิมพ์เอกสารหลักฐานการสมัคร</a><?php
                                    }
                                } else {
                                    ?>
